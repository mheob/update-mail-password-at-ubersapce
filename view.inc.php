    ...
    <main class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <p class="text-muted text-center text-lg-right">
            Bei Rückfragen steht Dir <a href="mailto:webmaster@tsg-irlich.de?subject=[<?php echo $inputValues["mail"]; ?>] Probleme mit Resetten von meinem Mail-Passwort">Dein Administrator</a> gerne zur Verfügung.
          </p>
        </div>
      </div>
    </main>
